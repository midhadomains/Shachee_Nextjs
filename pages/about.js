      ...
      <section className="py-12 lg:py-16 space-y-6">
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a href={site.resumeUrl} target="_blank" rel="noreferrer" download className="px-4 py-2 bg-brand-700 text-white rounded-lg text-sm font-semibold hover:bg-brand-800 transition">
